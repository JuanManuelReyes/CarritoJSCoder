...
const mostrarCards = (data) => {
  data.forEach((producto) => {
    ...
    templateCard
      .querySelector("img")
      .setAttribute("src", producto.imgProd);
...
const mostrarTabla = () => {
  ...
  if (Object.keys(carrito).length === 0) {
    footer.innerHTML = `<th scope="row" colspan="5">Su Carrito está Vacío - Comienza a Comprar!</th>`;
...
//Funcion JQuery para aplicar el Modo Oscuro
$(".checkbox").click(function () {
  if ($("input.checkbox").is(":checked")) {
    $(".tema").attr("href", "./styles/darkModeStyles.css");
  } else {
    $(".tema").attr("href", "./styles/lightModeStyles.css");
  }
});
